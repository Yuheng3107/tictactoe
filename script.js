...
let gameboard = function() {
    ...
    spaces.forEach(space => {
        space.addEventListener('click', (e) => {
            ...
            gameboard.makeMove(spaces.indexOf(e.target));
            }
    ...
    function checkWinner() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if ((board[0][i] === board[1][i]) && (board[1][i] === board[2][i]) && board[0][i] !== null) displayWinner();
        }
        ...
        if ((board[0][2] === board[1][1]) && (board[1][1] === board[2][0])) displayWinner();
    }
    ...
    return {initialise, displayGrid, setStartingSymbol, makeMove}
